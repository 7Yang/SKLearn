...
def _check_boundary_response_method(estimator, response_method):
    ...
    response_method : {'auto', 'predict_proba', 'decision_function', 'predict'}
        Specifies whether to use :term:`predict_proba`, :term:`decision_function`, :term:`predict` as the target response.
        If set to 'auto', the response method is tried in the following order: :term:`decision_function`, :term:`predict_proba`, :term:`predict`.
...
class DecisionBoundaryDisplay:
    ...
    It is recommended to use :func:`~sklearn.inspection.DecisionBoundaryDisplay.from_estimator` 
    to create a :class:`DecisionBoundaryDisplay`. All parameters are stored as attributes.
    ...
    surface_ : matplotlib `QuadContourSet` or `QuadMesh`
        If `plot_method` is 'contour' or 'contourf', `surface_` is a :class:`QuadContourSet <matplotlib.contour.QuadContourSet>`. 
        If `plot_method` is 'pcolormesh', `surface_` is a :class:`QuadMesh <matplotlib.collections.QuadMesh>`.
    ...
    def plot(self, plot_method="contourf", ax=None, xlabel=None, ylabel=None, **kwargs):
        ...
        plot_method : {'contourf', 'contour', 'pcolormesh'}, default='contourf'
            ...
            Please refer to the following matplotlib documentation for details:
    ...
    @classmethod
    def from_estimator(cls, estimator, X, *, grid_resolution=100, eps=1.0, plot_method="contourf", \
        response_method="auto", xlabel=None, ylabel=None, ax=None, **kwargs):
        """
        ...
        grid_resolution : int, default=100
            ...
            Higher values will make the plot look nicer but be slower to render.
        ...
        response_method : {'auto', 'predict_proba', 'decision_function', 'predict'}, default='auto'
            ...
            For multiclass problems, :term:`predict` is selected when `response_method="auto"`.

        xlabel : str, default=None
            The label used for the x-axis. If `None`, an attempt is made to extract a label from `X` if it is a dataframe, 
            otherwise an empty string is used.

        ylabel : str, default=None
            The label used for the y-axis. If `None`, an attempt is made to extract a label from `X` if it is a dataframe, 
            otherwise an empty string is used.
        ...
        **kwargs : dict
        ...
        sklearn.metrics.ConfusionMatrixDisplay.from_estimator : Plot the confusion matrix given an estimator, the data, and the label.
        sklearn.metrics.ConfusionMatrixDisplay.from_predictions : Plot the confusion matrix given the true and predicted labels.
        ...
        if not grid_resolution > 1:
            raise ValueError("grid_resolution must be greater than 1. Got {grid_resolution} instead.")
