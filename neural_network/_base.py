...
def inplace_identity_derivative(Z, delta):
    ...
    Z : {array-like, sparse matrix}, shape (n_samples, n_features)
        The data which was output from the identity activation function during the forward pass.

    delta : {array-like}, shape (n_samples, n_features), The backpropagated error signal to be modified inplace.
    """
    # Nothing to do
...
def inplace_logistic_derivative(Z, delta):
    ...
    ----------
    Z : {array-like, sparse matrix}, shape (n_samples, n_features)
        The data which was output from the logistic activation function during the forward pass.
...
def inplace_tanh_derivative(Z, delta):
    ...
    ----------
    Z : {array-like, sparse matrix}, shape (n_samples, n_features)
        The data which was output from the hyperbolic tangent activation function during the forward pass.
...
def inplace_relu_derivative(Z, delta):
    ...
    ----------
    Z : {array-like, sparse matrix}, shape (n_samples, n_features)
        The data which was output from the rectified linear units activation function during the forward pass.
...
def log_loss(y_true, y_prob):
    ...
    Parameters
    ----------
    y_true : array-like or label indicator matrix, Ground truth (correct) labels.
