...
class BernoulliRBM(ClassNamePrefixFeaturesOutMixin, TransformerMixin, BaseEstimator):
    ...
    h_samples_ : array-like of shape (batch_size, n_components)
        ...
        where `batch_size` is the number of examples per minibatch and `n_components` is the number of hidden units.
    ...
    [2] Tieleman, T. Training Restricted Boltzmann Machines using Approximations to the Likelihood Gradient. International Conference
    ...
    def transform(self, X):
        ...
        Returns
        -------
        h : ndarray of shape (n_samples, n_components), Latent representations of the data.
        """
    ...
    def _sample_hiddens(self, v, rng):
        ...
        Returns
        -------
        h : ndarray of shape (n_samples, n_components), Values of the hidden layer.
        """
    ...
    def _free_energy(self, v):
        ...
        Returns
        -------
        free_energy : ndarray of shape (n_samples,), The value of the free energy.
        """
    ...
    def _fit(self, v_pos, rng):
        ...
        Adjust the parameters to maximize the likelihood of v using Stochastic Maximum Likelihood (SML).
    ...
    def score_samples(self, X):
        ...
        Notes
        -----
        This method is not deterministic: it computes a quantity called the free energy on X, 
