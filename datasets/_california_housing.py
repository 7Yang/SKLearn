...
average income, housing average age, average rooms, average bedrooms, population, average occupation, latitude, and longitude in that order.
...
ARCHIVE = RemoteFileMetadata(filename="cal_housing.tgz",
...
def fetch_california_housing(*, data_home=None, download_if_missing=True, return_X_y=False, as_frame=False):
    ...
    if not exists(filepath):
        ...
        archive_path = _fetch_remote(ARCHIVE, dirname=data_home) # fetch_remote !!!
