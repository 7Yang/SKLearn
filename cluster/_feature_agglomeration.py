""" Feature agglomeration. Base classes and functions for performing feature agglomeration.  """
...
class AgglomerationTransform(TransformerMixin):
    ...
    # This prevents ``set_split_inverse_transform`` to be generated for the non-standard ``Xred`` arg on ``inverse_transform``.
    ...
    def transform(self, X):
        ...
        Returns
        -------
        Y : ndarray of shape (n_samples, n_clusters) or (n_clusters), The pooled values for each feature cluster.
        """
