...
class Bunch(dict):
    ...
    def __setstate__(self, state):
        # Bunch pickles generated with scikit-learn 0.16.* have an non empty __dict__. 
        # This causes a surprising behaviour when loading these pickles scikit-learn 0.17: reading bunch.key
        # uses __dict__ but assigning to bunch.key use __setattr__ and only changes bunch['key']. 
        # More details can be found at: https://github.com/scikit-learn/scikit-learn/issues/6196.
        # Overriding __setstate__ to be a noop has the effect of ignoring the pickled __dict__
        pass
