...
def _get_sys_info():
    ...
    Returns
    -------
    sys_info : dict, system and Python version information
    """
...
def _get_deps_info():
    ...
    This function does not import the modules to collect the version numbers but instead relies on standard Python package metadata.
