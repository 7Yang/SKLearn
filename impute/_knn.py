...
class KNNImputer(_BaseImputer):
    ...
    * Olga Troyanskaya, Michael Cantor, Gavin Sherlock, Pat Brown, Trevor Hastie, Robert Tibshirani, David Botstein and Russ B. Altman, 
      Missing value estimation methods for DNA microarrays, BIOINFORMATICS Vol. 17 no. 6, 2001 Pages 520-525.
    ...
    def __init__(self, *, missing_values=np.nan, n_neighbors=5, weights="uniform", metric="nan_euclidean", copy=True, \
    ...
    def _calc_impute(self, dist_pot_donors, n_neighbors, fit_X_col, mask_fit_X_col):
        ...
        dist_pot_donors : ndarray of shape (n_receivers, n_potential_donors)
            Distance matrix between the receivers and potential donors from training set. 
            There must be at least one non-nan distance between a receiver and a potential donor.
        ...
        Returns
        -------
        imputed_values: ndarray of shape (n_receivers,), Imputed values for receiver.
        """
        # Get donors
    ...
    def fit(self, X, y=None):
        ...
        Returns
        -------
        self : object, The fitted `KNNImputer` class instance.
        """
    ...
    def transform(self, X):
        ...
        if not np.any(mask):
            ...
            # Even if there are no missing values in X, we still concatenate Xc with the missing value indicator matrix, X_indicator.
            # This is to ensure that the output maintains consistency in terms of columns, regardless of whether missing values exist in X or not.
        ...
        gen = pairwise_distances_chunked(X[row_missing_idx, :], self._fit_X, metric=self.metric, missing_values=self.missing_values, \
            force_all_finite=force_all_finite, reduce_func=process_chunk)
        for chunk in gen:
    ...
    def get_feature_names_out(self, input_features=None):
        ...
        input_features : array-like of str or None, default=None
            ...
            - If `input_features` is `None`, then `feature_names_in_` is
              used as feature names in. If `feature_names_in_` is not defined, then the following input feature names are generated:
