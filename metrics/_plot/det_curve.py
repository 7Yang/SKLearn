...
class DetCurveDisplay(_BinaryClassifierCurveDisplayMixin):
    ...
    It is recommend to use :func:`~sklearn.metrics.DetCurveDisplay.from_estimator` or :func:`~sklearn.metrics.DetCurveDisplay.from_predictions` 
    ...
    def from_estimator(cls, estimator, X, y, *, sample_weight=None, response_method="auto", pos_label=None, name=None, ax=None, **kwargs):
        """
        Plot DET curve given an estimator and data. Read more in the :ref:`User Guide <visualizations>`.
        ...
        response_method : {'predict_proba', 'decision_function', 'auto'} default='auto'
            Specifies whether to use :term:`predict_proba` or :term:`decision_function` as the predicted target response. 
    ...
    def from_predictions(cls, y_true, y_pred, *, sample_weight=None, pos_label=None, name=None, ax=None, **kwargs):
        """
        Plot the DET curve given the true and predicted labels. Read more in the :ref:`User Guide <visualizations>`.
    ...
    def plot(self, ax=None, *, name=None, **kwargs):
        ...
        **kwargs : dict
        ...
        Returns
        -------
        display : :class:`~sklearn.metrics.DetCurveDisplay` Object that stores computed values.
        """
        ...
        if "label" in line_kwargs: self.ax_.legend(loc="lower right")
