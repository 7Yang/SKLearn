...
class KNeighborsRegressor(KNeighborsMixin, RegressorMixin, NeighborsBase):
    ...
    effective_metric_ : str or callable
        The distance metric to use. It will be same as the `metric` parameter or a synonym of it, 
    ...
    .. warning::
       ...
       neighbor `k+1` and `k`, have identical distances but different labels, the results will depend on the ordering of the training data.
    ...
    def __init__(self, n_neighbors=5, *, weights="uniform", algorithm="auto", leaf_size=30, p=2, metric="minkowski", metric_params=None, n_jobs=None):
        super().__init__(n_neighbors=n_neighbors, algorithm=algorithm, leaf_size=leaf_size, metric=metric, p=p, metric_params=metric_params, \
            n_jobs=n_jobs)
    ...
    def fit(self, X, y):
        ...
        Returns
        -------
        self : KNeighborsRegressor, The fitted k-nearest neighbors regressor.
        """
...
class RadiusNeighborsRegressor(RadiusNeighborsMixin, RegressorMixin, NeighborsBase):
    ...
    def fit(self, X, y):
        ...
        Returns
        -------
        self : RadiusNeighborsRegressor, The fitted radius neighbors regressor.
        """
        return self._fit(X, y)
