"""
Creates or updates an issue if the CI fails. This is useful to keep track of scheduled jobs that are failing repeatedly.
...
This scope allows the bot to create and edit its own issues. 
It is best to use a github account that does **not** have commit access to the public repo.
"""
...
parser.add_argument("--tests-passed", help=("If --tests-passed is true, then the original issue is closed if the issue exists. "
    "If tests-passed is false, then the an issue is updated or created."))
