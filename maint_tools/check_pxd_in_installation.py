...
with tempfile.TemporaryDirectory() as tmpdir:
    ...
    # A cython test file which cimports all modules corresponding to found pxd files.
    ...
    # We set the language to c++ and we use numpy.get_include() because some modules require it.
    with open(tmpdir / "setup_tst.py", "w") as f:
        f.write(textwrap.dedent("""
            ...
            extensions = [Extension("tst", sources=["tst.pyx"], language="c++", include_dirs=[numpy.get_include()])]
