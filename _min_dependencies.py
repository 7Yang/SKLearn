...
#
# NumPy version should match oldest-supported-numpy for the minimum supported Python version.
...
# It will NOT be included in setup's extras_require The values are (version_spec, comma separated tags)
dependent_packages = {
    ...
    # XXX: Pin conda-lock to the latest released version (needs manual update from time to time)
