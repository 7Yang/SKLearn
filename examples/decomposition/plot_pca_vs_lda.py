...
The Iris dataset represents 3 kind of Iris flowers (Setosa, Versicolour and Virginica) with 4 attributes: 
...
or directions in the feature space) that account for the most variance in the data. 
