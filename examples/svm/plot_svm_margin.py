...
for name, penalty in (("unreg", 1), ("reg", 0.05)):
    ...
    # plot the parallels to the separating hyperplane that pass through the support vectors (margin away from hyperplane in direction perpendicular to hyperplane). This is sqrt(1+a^2) away vertically in 2-d.
    ...
    plt.scatter(clf.support_vectors_[:, 0], clf.support_vectors_[:, 1], s=80, facecolors="none", zorder=10, edgecolors="k", cmap=plt.get_cmap("RdBu"))
