...
for i, C in enumerate([1, 100]):
    ...
    # we can also calculate the decision function manually decision_function = np.dot(X, clf.coef_[0]) + clf.intercept_[0]
    # The support vectors are the samples that lie within the margin boundaries, whose size is conventionally constrained to 1
