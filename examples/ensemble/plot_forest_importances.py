...
#     See :ref:`permutation_importance` as an alternative below.
import time
import numpy as np
...
# -----------------------------------------------
# Permutation feature importance overcomes limitations of the impurity-based feature importance: they do not have a bias toward high-cardinality features
...
# Please see :ref:`permutation_importance` for more details. We can now plot the importance ranking.
...
# As seen on the plots, MDI is less likely than permutation importance to fully omit a feature.
