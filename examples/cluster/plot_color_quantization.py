...
Performs a pixel-wise Vector Quantization (VQ) of an image of the summer palace (China), 
...
Using a single byte, up to 256 colors can be addressed, whereas an RGB encoding requires 3 bytes per pixel. 
The GIF file format, for example, uses such a palette.
