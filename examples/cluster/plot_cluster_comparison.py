...
For this example, the null dataset uses the same parameters as the dataset in the row above it, 
...
(blobs, {"min_samples": 7, "xi": 0.1, "min_cluster_size": 0.2}), (no_structure, {})]
...
for i_dataset, (dataset, algo_params) in enumerate(datasets):
    ...
    two_means = cluster.MiniBatchKMeans(n_clusters=params["n_clusters"], n_init="auto", random_state=params["random_state"])
