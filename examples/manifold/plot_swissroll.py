...
===========================================================================================================================
This notebook seeks to compare two popular non-linear dimensionality techniques, 
T-distributed Stochastic Neighbor Embedding (t-SNE) and Locally Linear Embedding (LLE), on the classic Swiss Roll dataset.
Then, we will explore how they both deal with the addition of a hole in the data.
"""
# %%
# Swiss Roll
# ---------------------------------------------------
...
# %%
# Computing the LLE and t-SNE embeddings, we find that LLE seems to unroll the Swiss Roll pretty effectively. 
# t-SNE on the other hand, is able to preserve the general structure of the data, 
# but, poorly represents the continuous nature of our original data. Instead, it seems to unnecessarily clump sections of points together.
...
# %%
# .. note::
#     LLE seems to be stretching the points from the center (purple) of the swiss roll. 
#     However, we observe that this is simply a byproduct of how the data was generated. There is a higher density of points near the center of the roll,
#     which ultimately affects how LLE reconstructs the data in a lower dimension.
...
# %%
# Computing the LLE and t-SNE embeddings, we obtain similar results to the Swiss Roll. 
# LLE very capably unrolls the data and even preserves the hole. t-SNE, again seems to clump sections of points together, 
# but, we note that it preserves the general topology of the original data.
