...
The dataset used in this example is a preprocessed excerpt of the "Labeled Faces in the Wild", aka LFW_:
  http://vis-www.cs.umass.edu/lfw/lfw-funneled.tgz (233MB), _LFW: http://vis-www.cs.umass.edu/lfw/
...
# %%
# Face recognition problem would be much more effectively solved by training convolutional neural networks 
# but this family of models is outside of the scope of the scikit-learn library. 
# Interested readers should instead try to use pytorch or tensorflow to implement such models.
